...
import Ourdata from "./OurProData";
      ...
      <div className="px-[15px] mt-[50px] md:px-[55px] mx-auto">
        <div className="text-center space-y-3">
          ...
          <div className="flex items-center justify-between md:justify-center  md:space-x-8 ">
            <p className="font-Mulish font-medium  text-[14px] md:text-[20px]  text-green">
              All Products
            </p>
            <p className="font-Mulish font-medium   text-[14px] md:text-[20px] leading-[30px] text-c2 text-c3">
              Best Sellers
            </p>
            <p className="font-Mulish font-medium text-[14px] md:text-[20px] leading-[30px] text-c3 ">
              New Arrivals
            </p>
            <p className="font-Mulish font-medium text-[14px] md:text-[20px] leading-[30px] text-c3 ">
              Todays Deals
